...
await getMarginAsync();
    ...
    <>
      ...
      >
        ...
        >
          <>
            {" "}
            <ShowChartIcon sx={{marginLeft:"10px",           fontSize:"25px",}}/><Typography sx={{ fontFamily: "Manrope, sans-serif",fontWeight:'bold',           fontSize:"20px",}} >Stock Prices</Typography>
  ...
  <Grid item xs={4.5} sm={4.5}>
    <div  style={{ color: 'black', fontSize: "14px" ,textAlign:"left",fontWeight: "bold"}}>
...
style={{ fontSize: "14px" }}
    ...
    <div style={{ color: getTickerColor(item.percentage), textAlign: "center", cursor: "pointer" }}>
      {arrowDirection === "down" ? <ExpandLess /> : <ExpandMore />}
                      ...
                      {!user.pausesSession && (
  <>
  <Box sx={{display:"flex",justifyContent:"center",alignItems:"center",width:'300px',marginTop:"20px",fontsize:"2px",}}>
    <Box
      sx={{
        background: "#4184f3",
        width: "40px",
      ...
      Sell
           ...
           Quantity
                      ...
                      <TextField
                          ...
                          style={{ marginTop: "1em" }}
                        />
                          <div style={{marginTop:"10px",marginBottom:"0px" }} required>
        Price
          </div>
                         <TextField
                        size="small"
